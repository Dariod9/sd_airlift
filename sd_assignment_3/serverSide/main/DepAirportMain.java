...
public class DepAirportMain {
    ...
    public static void main(String[] args) {
        ...
        Compute depAirportStub = null;
        int listeningPort = 22330;                                      /* it should be set accordingly in each case */

        try
        { depAirportStub = (Compute) UnicastRemoteObject.exportObject (engine, listeningPort);
        }
