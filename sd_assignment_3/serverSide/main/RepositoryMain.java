...
public class RepositoryMain {
    ...
    public static void main(String[] args) {
        ...
        Compute repositoryStub = null;
        int listeningPort = 22333;                                      /* it should be set accordingly in each case */

        try
        { repositoryStub = (Compute) UnicastRemoteObject.exportObject (engine, listeningPort);
        }
