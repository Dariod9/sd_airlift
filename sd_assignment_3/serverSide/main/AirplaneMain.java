...
import serverSide.ComputeEngine;
...
public class AirplaneMain {
    ...
    public static void main(String[] args) {
        ...
        Compute airplaneStub = null;
        int listeningPort = 22332;                                      /* it should be set accordingly in each case */

        try
        { airplaneStub = (Compute) UnicastRemoteObject.exportObject (engine, listeningPort);
        }
        ...
        try
        { reg.bind (nameEntryObject, airplaneStub);
        }
        catch (RemoteException e)
