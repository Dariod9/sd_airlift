...
public class DestAirportMain {
    ...
    public static void main(String[] args) {
        ...
        Compute destAirportStub = null;
        int listeningPort = 22331;                                      /* it should be set accordingly in each case */

        try
        { destAirportStub = (Compute) UnicastRemoteObject.exportObject (engine, listeningPort);
        }
